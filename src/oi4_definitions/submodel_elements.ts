...
export namespace submodel_elements {
    ...
    export class BasicEventElement extends EventElement {
        ...
        public constructor(opt: {
            ...
            if (opt.minInterval)
                this.minInterval = new xs.dateTime(
                    opt.minInterval?.input_string
                );
            if (opt.maxInterval)
                this.maxInterval = new xs.dateTime(
                    opt.maxInterval?.input_string
                );
        }
    }
